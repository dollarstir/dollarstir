...
<head>
    ...
    <title>Dollar Stir - Add Product</title>
            ...
            <ul class="dropdown-menu">
              <div class="arrow_box">
                ...
                <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown">Form Layouts</a>
                  <ul class="dropdown-menu">
                    <div class="arrow_box">
                      <li class="active" data-menu=""><a class="dropdown-item" href="form-layout-basic.html" data-toggle="dropdown">Basic Forms</a>
                      </li>
						...
						<form class="form">
							<div class="form-body">
								...
								<h4 class="form-section">
									<i class="ft-briefcase"></i> Portfolio  Form</h4>
		...
		<div class="col-lg-10 col-md-12">
			<div class="card">
				<div class="card-header">
					<center><h4 class="card-title" id="basic-layout-form-center">Products Form</h4></center>
				...
				<div class="card-content collapse show">
					<div class="card-body">
						...
						<form class="form" id="adpro" enctype="multipart/form-data">
							<div class="row justify-content-center">
								<div class="col-8">
									<div class="form-body">
										<div class="form-group">
											<label for="eventRegInput1">Product Name</label>
											<input type="text" id="eventRegInput1" class="form-control" placeholder="project name" name="pname">
										</div>

										<div class="form-group">
											<label for="eventRegInput2">Developer's name</label>
											<input type="text" id="eventRegInput2" class="form-control" placeholder="Customer name" name="developer">
										</div>
										...
										<div class="form-group">
											<label for="eventRegInput5">Developer's Number</label>
											<input type="tel" id="eventRegInput5" class="form-control" name="devcontact" placeholder="Developer's number">
                                        </div>
                                        ...
                                        <fieldset class="form-group">
                                            <select class="custom-select" id="customSelect" name="category">
                                                ...
                                                <option value="4">Android /IOS Apps</option>
                                                <option value="5">Desktop Apps</option>
                                            </select>
                                        </fieldset>


                                        <fieldset class="form-group">
                                            <select class="custom-select" id="customSelect" name="ptype">
										...
										<div class="form-group">
											<label for="eventRegInput5">Download Url</label>
											<input type="text" id="eventRegInput6" class="form-control" name="website" placeholder="http://">
                                        </div>
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="inputGroupFile01" name="image2" multiple>
                                                <label class="custom-file-label" for="inputGroupFile01">Choose second image</label>
                                            </div>
                                        </fieldset>
                                        ...
                                        <fieldset class="form-group">
                                            <label for="">Other Images</label>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="inputGroupFile01" name="image3" multiple>
                                                <label class="custom-file-label" for="inputGroupFile01">Choose second image</label>
                                            </div>
                                        </fieldset>
                                        
                                        <div class="form-group">
									        <label for="companyinput8">About Project</label>
									        <textarea id="companyinput8" rows="5" class="form-control" name="description" placeholder="About project"></textarea>
								        </div>
                            ...
                            <div class="fback">
                                <!-- <div class="alert alert-success mb-2" role="alert" id="fout">
...
<!-- // Basic form layout section end -->
    ...
    <footer class="footer footer-static footer-light navbar-shadow">
      <div class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2"><span class="float-md-left d-block d-md-inline-block">2019  &copy; Copyright <a class="text-bold-800 grey darken-2" href="https://dollarstir.com/" target="_blank">Dollarstir</a></span>
    ...
    <script src="../../../app-assets/js/scripts/forms/custom-file-input.min.js"></script>
