...
<head>
    ...
    <title>Dollar Stir - Add portfolio</title>
		...
		<div class="col-lg-10 col-md-12">
			<div class="card">
				<div class="card-header">
					<center><h4 class="card-title" id="basic-layout-form-center">Portfolio Form</h4></center>
				...
				<div class="card-content collapse show">
					<div class="card-body">
						...
						<form class="form" id="adp" enctype="multipart/form-data">
							<div class="row justify-content-center">
								<div class="col-8">
									<div class="form-body">
										...
										<div class="form-group">
											<label for="eventRegInput2">Customer name</label>
											<input type="text" id="eventRegInput2" class="form-control" placeholder="Customer name" name="customer">
										</div>
										...
										<div class="form-group">
											<label for="eventRegInput5">Website Url</label>
