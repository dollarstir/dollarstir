...
<html class="no-js" lang="zxx">
    <head>
		...
		<!-- Title Tag -->
        <title>Dollarsoft &minus; Download</title>
			...
			<div class="container">
				<div class="row">
					...
					<?php
						...
						$getpro = mysqli_query($conn, "SELECT * FROM products WHERE id ='$portid' ");
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="portfolio-single slider">
							<div class="single-slide">
								<img src="admin/html/ltr/pages/<?php echo $pic;?>" alt="" style="height:700px;"/>
							</div>
							<div class="single-slide">
								<img src="admin/html/ltr/pages/<?php echo $pic2;?>" alt="" style="height:700px;"/>
							</div>
							<div class="single-slide">
								<img src="admin/html/ltr/pages/<?php echo $pic3;?>" alt="" style="height:700px;"/>
							</div>
						</div>
					</div>
					<!--/ End portfolio -->
				...
				<div class="row">	
					...
					<div class="col-md-8 col-sm-8 col-xs-12">
						<div class="content">
							...
							<br><br>
							<div class="downloading"> </div><br><br>
							<form id="mylink">
								<input type="hidden" name="link" value="<?php echo $website;?>">
								<input type="hidden" value="<?php echo $name;?>" name="name">
								<center> <button type="submit" name="btnlink" class="dsbut"><i class="fa fa-download"></i> Download Now</button></center>
							</form><br><br>
				...
				<div class="row">	
					<div class="col-md-12">
						<div class="portfolio-related">
							<?php
							$portid =$_POST['portid'];
							$gg = mysqli_query($conn,"SELECT * FROM products WHERE id = '$portid' ");
							$rc = mysqli_fetch_array($gg);
							$catid = $rc['category'];
							$mid = $rc['id'];

								relatedprod($mid,$catid);
							?>
