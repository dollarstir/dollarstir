                                                ...
                                                <form class="form" method="post" action="" id="myform" style="height:auto;">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6" id="ep">
                                                            <div class="form-group">
                                                                <input type="text" name="payemail"  placeholder="Enter paypal email" required="required">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6" id="np">
                                                            <div class="form-group">
                                                             <input type="text" name="payname"  placeholder="Enter paypal account name" required="required">
                                                            </div>
                                                        </div>

                                                        <div class="col-md-12" id="ad1">
                                                            <div class="form-group">
                                                                <input type="text" name="address1"  placeholder="Enter Residential/Street Address  for your paypal account" required="required">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6" id="ct">
                                                            <div class="form-group">
                                                                <input type="text" name="city"  placeholder="Enter city you will use for paypal" required="required">
                                                            </div>
                                                        </div>
